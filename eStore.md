...
The big things I learned from this experience (I will take these ideas with me forever):

 * Don't try to implement a state of the art module on the first go around. Develop your base level functionality and develop ITERATIVELY. This way you can understand exactly where/when you went wrong. This is much tougher to do when trying to implement multiple aspects of a functionality at once. I had problems with this previously because I was lazy and thought bust out a state-of-the-art feature on the first try even without much previous experience with that specific feature. 

 * BUILD on your knowledge. Break a daunting task down into many smaller more attainable tasks and complete those tasks one by one. And if you do so, you will reach your goal.

 * You must understand things from a high level before digging around in the mud and implementing lower level functionalities. You need to understand where a module fits in the grand scheme of your application. This allows you to think for yourself. This is critical for building your MENTAL MODEL. Something I have found is absolutely critical. A mental model is basically your mental visualization of a concept. We think in ideas. If you cant "zoom out", you cant understand a module's practical use. And if you cant understand that, you will truly be lost. 

 * Overall, convert your task(s) into something that can conceptualize. Start simple and iterate on that basic idea. I like to use a tree as an example. Our base level understanding is like the tree trunk, and then we can get more and more specific on the increasingly technical aspects needed to understand the topic. Each of these abstractions adds a branch to the tree. The first few branches are fewer and larger. Then increasingly many in number and much smaller and more intricate/precise. Taking a topic and determining it's characteristics in such a way takes advantage of the way that humans understand things. Similar to the way the world wide web works. You read an articale and you find many subtopics for that topic that are needed to be understood to properly understand that topic. You click the hyperlink and read that article, and you find more articles, etc. Tim Berners-Lee said that he designed the web in this way because it takes advantage of the way that humans naturally think.
 ...
 * I learned a lot about learning and what my personal pitfalls are when it comes to learning:
    ...
    2. Be observant/open your eyes/be ready to learn

    3. humility/realize you can always and must improve if you don't want to be left behind and stay on the same level forever

 * I am very happy with the technologies I chose for development and deployment and what I learned about these technologies.

 * I learned about my work process and how I can improve it in the future.

 * My use of problem-solving skills.

 * The development, deloyment, and maintenance of the application was and is 100% free.
